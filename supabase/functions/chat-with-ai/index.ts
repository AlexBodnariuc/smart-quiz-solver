...
serve(async (req) => {
  ...
  try {
    ...
    console.log('Using provided API key, making request to Respell API...');
    ...
    // Make request to Respell API with proper headers
    ...
    console.log('Respell API Response received');
